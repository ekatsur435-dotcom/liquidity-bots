...
class ShortFilter:
    ...
    # ✅ FIX v7: BTC_STRONG_UP теперь читается из ENV, дефолт 4.0%
    # Установите BTC_BLOCK_SHORT_THRESHOLD=99 чтобы полностью отключить блокировку
    BTC_STRONG_UP_THRESHOLD = float(os.getenv("BTC_BLOCK_SHORT_THRESHOLD", "4.0"))
...
SHORT_TP_WEIGHTS_CONSERVATIVE = [25, 20, 20, 20, 10, 5]   # TP1=25%, TP2-4=20%, TP5=10%, TP6=5%
SHORT_TP_WEIGHTS_STANDARD     = [25, 20, 20, 20, 10, 5]   # TP1=25%, TP2-4=20%, TP5=10%, TP6=5%
SHORT_TP_WEIGHTS_FAST_EXIT    = [25, 20, 20, 20, 10, 5]   # TP1=25%, TP2-4=20%, TP5=10%, TP6=5%
