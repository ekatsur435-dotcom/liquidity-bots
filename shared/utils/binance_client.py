...
class BinanceFuturesClient:
    ...
    async def get_complete_market_data(self, symbol: str) -> Optional[MarketData]:
        ...
        try:
            ...
            print(f"[MarketData DEBUG] {symbol}: taker={taker_buy_sell_ratio}, liq=${recent_liquidations_usd:,.0f if recent_liquidations_usd else 0}, top_ls={top_trader_long_short_ratio}")
